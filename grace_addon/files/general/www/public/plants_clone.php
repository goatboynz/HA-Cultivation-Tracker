    ...
    <main class="container">
        ...
        <div class="grid">
            <div>
                ...
                <p><small>Individual clone management and tracking</small></p>
            </div>
            <div style="text-align: right;">
                <button onclick="refreshData()" class="button secondary">Refresh</button>
                <a href="receive_genetics.php" class="button">Add Clones</a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="grid">
                ...
                <div>
                    ...
                    <select id="motherFilter" class="input">
        ...
        <div id="noDataMessage" style="display: none;">
            <p>No clone stage plants found.</p>
        </div>
    </main>
            ...
            filteredClones.forEach(plant => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        ...
                        <button onclick="moveToVeg(${plant.id})" class="button small">→ Veg</button>
